...
export function GitHubBadge() {
  ...
  return (
    <a
      ...
      className="hidden sm:inline-flex min-h-9 items-center gap-1.5 rounded-md px-2 text-sm text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground"
    >
